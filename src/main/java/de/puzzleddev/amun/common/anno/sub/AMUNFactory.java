 ...
 * it can be placed on any static factory functions, constructors, fields that contain an instance or on the class itself where it expects an empty constructor.
 * 
 * @author tim4242
 */
