...
{
	/**
	 * Gets a {@link ConfigValue} of the appropriate type from a configuration
	 * file.<br>
	 * This creates a new element in the configuration file if no element was
	 * found at the given path.
	 * 
	 * @param type
	 *            The type of object to load, may be restricted by specific
	 *            implementations.
	 * @param path
	 *            The local path of the data (in file) if a layered structure
	 *            exists.
	 * @param comment
	 *            The comment to set if no element is found.
	 * @param def
	 *            The default value to set if no element is found.
