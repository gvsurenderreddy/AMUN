...
public interface IAmunAnnotationManager extends IAMUNLoadHook
{
	 ...
	 * iterations 0 through 9.<br>
	 * 0 - 4 before the registry is checked, so additional registration can
	 * happen here.
	 * 
	 * @param base
	 */
	...
	/**
	 * @return <b>The</b> {@link IAmunAnnotationRegistry} instance for this
	 *         annotation manager.
	 */
