...
public interface IScriptAPI
{
	 ...
	 * This shouldn't be called directly but script interfaces should use {@link de.puzzleddev.amun.common.script.anno.ScriptInterface ScriptInterface} to register themselves.
	 * 
